...
Public Class DBAccess
    ...
    Private cmd2 As IDbCommand = New SqlCommand()
    ...
    Public Sub New()
        ...
        'cnn.ConnectionString = ConfigurationManager.AppSettings("connString")
        cnn.ConnectionString = connString2 'ConfigurationManager.ConnectionStrings("MedicalManager.My.MySettings.MMDataConnectionString1").ConnectionString
        'cnn.ConnectionString = "Data Source=.\SQLEXPRESS;AttachDbFilename=|DataDirectory|\MMData.mdf;Integrated Security=True"
        cmd.Connection = cnn
    ...
    Public Function ExecuteReader() As SqlDataReader
        ...
        Try
            Me.Open()
            reader = cmd2.ExecuteReader(CommandBehavior.CloseConnection)
    ...
    Public Function ExecuteDataSet2() As DataSet
        Dim da As SqlDataAdapter = Nothing
        Dim ds As DataSet = Nothing
        Try
            da = New SqlDataAdapter()
            da.SelectCommand = CType(cmd2, SqlCommand)
            ds = New DataSet()
            da.Fill(ds)
        Catch ex As Exception
            If (handleErrors) Then
    ...
    Public Function ExecuteDataSet2(ByVal commandtext As String) As DataSet
        Dim ds As DataSet = Nothing
        Try
            cmd2.CommandText = commandtext
            ds = Me.ExecuteDataSet2()
        Catch ex As Exception
            If handleErrors Then
                strLastError = ex.Message
            Else
