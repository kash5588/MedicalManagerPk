...
Public Class HL7
    ...
    Private Sub HL71BindingNavigatorSaveItem_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs)
            Try

                  Me.Validate()
                  Me.HL71BindingSource.EndEdit()
                  Me.HL71TableAdapter.Update(Me.MMDataDataSet.HL71)
            Catch ex As System.Exception
                  System.Windows.Forms.MessageBox.Show(ex.Message)
            End Try
    End Sub

    Private Sub HL71BindingNavigatorSaveItem_Click_2(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles HL71BindingNavigatorSaveItem.Click
        Me.Validate()
        Me.HL71BindingSource.EndEdit()
        Me.HL71TableAdapter.Update(Me.MMDataDataSet.HL71)
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        msgText = "Import All"
        msgText = msgText & ControlChars.CrLf & "Save?"
        ...
        If result = Windows.Forms.DialogResult.Yes Then
            ...
            myDataTable1 = Me.MMDataDataSet.HL71
            ...
            For i = 0 To Me.MMDataDataSet.HL71.Rows.Count - 1
                ...
                ID = Me.MMDataDataSet.HL71.Rows(i)("Field1")



                If ID.Substring(0, 3) = "MSH" Then

                    MSH4SendingFacility = Me.MMDataDataSet.HL71.Rows(i)("Field5")
                    MSH7DateTime = Me.MMDataDataSet.HL71.Rows(i)("Field8") & ""

                ElseIf ID.Substring(0, 3) = "PID" Then

                    Dim PIDID As String
                    PIDID = Me.MMDataDataSet.HL71.Rows(i)("Field4") & ""
                    strValue = PIDID
                    strAryWords = Split(strValue, "^")



                    PID1SetID = Me.MMDataDataSet.HL71.Rows(i)("Field2") & ""
                    PID2PatientIDExt = strAryWords(0)    'Me.MMDataDataSet.HL71.Rows(i)("Field3") & ""
                    ' PID3PatientIDInt = strAryWords(4)     'Me.MMDataDataSet.HL71.Rows(i)("Field4") & ""
                    PID4AltPatientID = Me.MMDataDataSet.HL71.Rows(i)("Field5") & ""

                    Dim PIDName As String
                    PIDName = Me.MMDataDataSet.HL71.Rows(i)("Field6") & ""
                    ...
                    PID7DateOfBirth = Me.MMDataDataSet.HL71.Rows(i)("Field8") & ""
                    PID8Sex = Me.MMDataDataSet.HL71.Rows(i)("Field9") & ""

                    Dim PIDAdd As String

                    PIDAdd = Me.MMDataDataSet.HL71.Rows(i)("Field12") & ""
                    strValue = PIDAdd
                    ...
                    End If
                    PID13PhoneNumHome = Me.MMDataDataSet.HL71.Rows(i)("Field5") & ""
                    PID19SSNNumber = Me.MMDataDataSet.HL71.Rows(i)("Field6") & ""
                    ...
                    ElseIf ID.Substring(0, 3) = "OBR" Then
                        ...
                        ' OBR4 = Me.MMDataDataSet.HL71.Rows(i)("Field5") & ""
                        OBR1SetID = Me.MMDataDataSet.HL71.Rows(i)("Field2") & ""
                        OBR3FillerOrderNum = Me.MMDataDataSet.HL71.Rows(i)("Field4") & ""
                    ...
                    OBR6RequestedDateTime = Me.MMDataDataSet.HL71.Rows(i)("Field7") & ""
                    OBR7ObservDateTime = Me.MMDataDataSet.HL71.Rows(i)("Field8") & ""
                    OBR14SpecimanRecieveDateTime = Me.MMDataDataSet.HL71.Rows(i)("Field15") & ""
                    OBR15S1SpecimanSource = Me.MMDataDataSet.HL71.Rows(i)("Field6") & ""

                        Dim OBR16 As String
                        OBR16 = Me.MMDataDataSet.HL71.Rows(i)("Field17") & ""
                ...
                ElseIf ID.Substring(0, 3) = "OBX" Or ID.Substring(0, 3) = "NTE" Then
                    ...
                    newRow2("OBX1SetID") = Me.MMDataDataSet.HL71.Rows(i)("Field2")
                    newRow2("OBX2ValueType") = Me.MMDataDataSet.HL71.Rows(i)("Field3")


                    Dim OBX3 As String
                    OBX3 = Me.MMDataDataSet.HL71.Rows(i)("Field4") & ""
                    strValue = OBX3
                    strAryWords = Split(strValue, "^")



                    newRow2("OBX3S1ObservIdentifier") = strAryWords(0)
                    newRow2("OBX3S2TestName") = strAryWords(1)

                    newRow2("OBX4ObservSub") = Me.MMDataDataSet.HL71.Rows(i)("Field5")


                    Dim OBX5 As String
                    OBX5 = Me.MMDataDataSet.HL71.Rows(i)("Field6") & ""
                    ...
                    newRow2("OBX5S7Result") = Me.MMDataDataSet.HL71.Rows(i)("Field6") & ""


                    Dim OBX6 As String
                    OBX6 = Me.MMDataDataSet.HL71.Rows(i)("Field7") & ""
                    strValue = OBX6
                    strAryWords = Split(strValue, "^")



                    newRow2("OBX6Units") = strAryWords(0) ' Me.MMDataDataSet.HL71.Rows(i)("Field7")


                    Dim OBX7 As String
                    OBX7 = Me.MMDataDataSet.HL71.Rows(i)("Field8") & ""
                    strValue = OBX7
                    strAryWords = Split(strValue, "^")


                    newRow2("OBX7ReferenceRange") = strAryWords(0) 'Me.MMDataDataSet.HL71.Rows(i)("Field8")
                    newRow2("OBX8Flag") = Me.MMDataDataSet.HL71.Rows(i)("Field9")

                    newRow2("OBX11ObservResultsStatus") = Me.MMDataDataSet.HL71.Rows(i)("Field12")
                    newRow2("OBX14DateTimeObserv") = Me.MMDataDataSet.HL71.Rows(i)("Field13")
                    ...
                    '    newRow2("OBX1SetID") = Me.MMDataDataSet.HL71.Rows(i)("Field2")
                    '    newRow2("OBX3S1ObservIdentifier") = Me.MMDataDataSet.HL71.Rows(i)("Field4")
    ...
    ''cn.CursorLocation = ADODB.CursorLocationEnum.adUseClientBatch
    '' cn.Open("PROVIDER=Microsoft.Jet.OLEDB.4.0;Data Source=" & "C:\MedicaManager\MedicalManager\MedicalManager\MMDATA.mdb")


    'Dim rsResults As ADODB.Recordset
    'rsResults = New ADODB.Recordset


    '' Dim rsPatTest As ADODB.Recordset
    '' rsPatTest = New ADODB.Recordset
    'Dim rsPatTest = New ADODB.Recordset
    '' rsPatTest.LockType.adLockBatchOptimistic()
    'cn.Open("PROVIDER=Microsoft.Jet.OLEDB.4.0;Data Source=C:\MedicaManager\MedicalManager\MedicalManager\MMDATA.mdb;")

    'sql1 = "SELECT * From HL71"


    'rsResults = cn.Execute("SELECT * From HL71") 'WHERE PRFNO ='" & (ListView1.ListItems(X).Text) & "'")
    'rsPatTest = cn.Execute("SELECT * From HL7Reports")

    '' HL7ReportsBindingSource. = Me.MMDataDataSet.HL71.Rows(0)("Field1")



    'If Not rsResults.EOF = True Then
    '    ' If rsPatTest("Field1") = "" Or IsDBNull(rsPatTest("Field1")) Then
    '    If Not IsDBNull(rsPatTest(1)) Then
    '        rsPatTest(1) = Me.MMDataDataSet.HL71.Rows(0)("Field1")
    '        rsPatTest.Update()
    '        ' rsResults("POSTED") = "TRUE"
    '        rsResults.Update()
    '    End If
    'End If
    '' End If
    ...
    'Private Sub HL7_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load

    Private Sub HL7_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'MMDataDataSet.HL7Reports' table. You can move, or remove it, as needed.
        '  Me.HL7ReportsTableAdapter.Fill(Me.MMDataDataSet.HL7Reports)
        Me.HL71TableAdapter.Fill(Me.MMDataDataSet.HL71)
...
'If currentField = "OBR" Or currentField = "OBX" Or currentField = "ZLR" Or currentField = "PID" Or currentField = "MSH " Then

'                           My.Computer.FileSystem.WriteAllText("C:\Lab\HL7Spec\FileList.txt", currentField & Chr(13), True)
'                       Else
'                           My.Computer.FileSystem.WriteAllText("C:\Lab\HL7Spec\FileList.txt", currentField, True)
'                       End If